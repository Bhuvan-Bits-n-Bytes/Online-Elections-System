...
<body>
    ...
    <heading class="voters_heading">
        <center><h1>Registered Cultural Representative Candidates</h1>
           <center>
                <select onchange = "page(this.value)">
                <option disabled selected>Select Candidate Group</option>
                <option value = "pres.php">Student Representative</option>
                <option disabled selected>Cultural Representative</option>
                <option value = "ua.php">Sports Representative</option>
                <!-- <option value = "ss.php">NOTA</option> -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <thead class="thead header-background">                                 
