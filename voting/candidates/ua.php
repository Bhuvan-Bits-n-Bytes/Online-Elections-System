...
<body>
    ...
    <heading class="voters_heading">
        <center><h1>Registered Sports Representative Candidates</h1>
           <center>
                <select onchange = "page(this.value)">
                <option disabled selected>Select Candidate Group</option>
                <option value = "pres.php">Student Representative</option>
                <option value = "vp.php">Cultural Representative</option>
                <option disabled selected>Sports Representative</option>
